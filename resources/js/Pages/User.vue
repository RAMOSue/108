        ...
        <div class="flex h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto">
                <div class="container mx-auto px-6 py-8">
                    ...
                    >
                        <BookOpenIcon
                            class="h-24 w-24 text-indigo-400 mx-auto mb-4"
                        />
                        <p class="text-gray-500 text-lg">
                            No tribes found. Try adjusting your search or
                            filter.
                        </p>
                    </div>
                </div>
...
const filteredTribes = computed(() => {
    return tribes.value.filter((tribe) => {
        const matchesCategory =
            ...
            tribe.category_id === selectedCategory.value;
        const matchesSearch = tribe.tribe_name
            .toLowerCase()
