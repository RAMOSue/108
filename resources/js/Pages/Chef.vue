                    ...
                    <section id="recipes">
                        ...
                        >
                            ...
                            >
                                <img
                                    :src="
                                        recipe.url_image || '/placeholder.svg'
                                    "
                        ...
                        <div v-else class="text-center py-12">
                            ...
                            <p class="text-gray-500 text-lg">
                                No recipes found. Add a new recipe to get
                                started!
                            </p>
                        </div>
                    </section>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <form
                                        @submit.prevent="confirmSubmitRecipe"
                                        class="space-y-4"
                                    >
                                        <div>
                                            <label
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            >
                                                <li
                                                    v-for="ingredient in selectedRecipe?.ingredients.split(
                                                        '\n'
                                                    )"
                                                    :key="ingredient"
                                        ...
                                        <div>
                                            ...
                                            >
                                                <li
                                                    v-for="(
                                                        step, index
                                                    ) in selectedRecipe?.procedure.split(
                                                        '\n'
                                                    )"
                                                    :key="index"
                                                    class="mb-2 break-words"
...
const dashboardStats = computed(() => [
    {
        title: "Total Main Courses",
        value: props.stats[0].total_main_courses,
        icon: BookOpenIcon,
    },
    {
        title: "Total Appetizers",
        value: props.stats[0].total_appetizers,
        icon: FireIcon,
    },
    {
        title: "Total Desserts",
        value: props.stats[0].total_desserts,
        icon: TagIcon,
    },
    {
        title: "Total Beverages",
        value: props.stats[0].total_beverages,
        icon: BookmarkIcon,
    },
]);
            ...
            router.delete(route("chef.deleteRecipe", { recipe: recipeId }), {
                onSuccess: () => {
                    ...
                    creativeAlertConfig.value = {
                        action: "Deleted",
                        message:
                            "Your recipe has been removed from your collection.",
                    };
                },
                onError: (error) => {
...
const submitRecipe = () => {
    if (editingRecipe.value) {
        ...
        router.put(
            route("chef.updateRecipe", { recipe: recipeForm.value.id }),
            recipeForm.value,
            {
                preserveState: true,
                preserveScroll: true,
                onSuccess: () => {
                    ...
                    creativeAlertConfig.value = {
                        action: "Edited",
                        message:
                            "Your recipe has been updated from your collection.",
                    };
                },
                onError: (errors) => {
                    showAlert(
